    ...
    return(
        <div className="flex flex-col gap-5 w-1/4 my-4">
            {datas.map((item,index) => (
                ...
                >
                    <div className="flex justify-start gap-0.5 items-center font-josefin text-lg">
                    ...
                    <div className="flex w-1/2 justify-center items-center gap-1 ">
                        <div className="flex justify-center items-center gap-1 hover:bg-gray-300 hover:scale-95 ease-in-out transition-all duration-200 cursor-pointer
